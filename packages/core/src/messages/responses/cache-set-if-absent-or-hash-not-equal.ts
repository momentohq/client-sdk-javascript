...
interface IResponse {
  readonly type: CacheSetIfAbsentOrHashNotEqualResponse;
}

/**
 * Indicates either the key does not exist and the value was set or, the key exists
 * and hash value of the stored item is not equal to the hash value supplied and the value was set.
 */
export class Stored extends ResponseBase implements IResponse {
  readonly type: CacheSetIfAbsentOrHashNotEqualResponse.Stored =
    CacheSetIfAbsentOrHashNotEqualResponse.Stored;
...
/**
 * Indicates the key exists but the hash value is equal to the hash value supplied and no value was set.
 */
export class NotStored extends ResponseBase implements IResponse {
  readonly type: CacheSetIfAbsentOrHashNotEqualResponse.NotStored =
    CacheSetIfAbsentOrHashNotEqualResponse.NotStored;
}
...
export class Error extends BaseResponseError implements IResponse {
  ...
  readonly type: CacheSetIfAbsentOrHashNotEqualResponse.Error =
    CacheSetIfAbsentOrHashNotEqualResponse.Error;
}
