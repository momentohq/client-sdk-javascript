...
//       );
//
//       console.log('The client timeout interceptor has been called');
//
...
//         console.log(
//           'The client timeout interceptor is returning; detected timeout'
//         );
...
//         );
//         console.log(
//           'The client timeout interceptor is returning; reset overall and incremental deadline'
//         );
//         return new InterceptingCall(nextCall(options));
//       }
//
...
//
//       console.log(
//         'The client timeout interceptor is returning; detected incremental timeout'
//       );
//       return new InterceptingCall(nextCall(options));
//     };
//   }
