    ...
    while IFS= read -r line; do
       ...
       pushd $example_dir
          ...
          then
             ...
             npm install @gomomento/sdk@latest --save-exact
          fi
          ...
          then
             ...
             npm install @gomomento/sdk-nodejs-compression@latest --save-exact
          fi
          ...
          then
             ...
             npm install @gomomento/sdk-nodejs-compression-zstd@latest --save-exact
          fi
          ...
          then
             ...
             npm install @gomomento/sdk-web@latest --save-exact
          fi
       popd
    done <<< "$example_dirs"
popd
