...
*/
export async function GetApiKey(secretName: string, regionName = 'us-west-2'): Promise<string> {
  try {
...
export default async function CreateCacheClient(ttl = 600, apiKeySecretName = 'Momento_Api_Key'): Promise<CacheClient> {
