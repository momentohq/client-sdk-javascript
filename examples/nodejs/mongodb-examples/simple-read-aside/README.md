...
- The Momento API key from the [Momento Console](https://console.gomomento.com) stored in [AWS Secrets Manager](https://docs.momentohq.com/develop/integrations/aws-secrets-manager) as text.
- A [Momento service endpoint](https://docs.momentohq.com/platform/regions) stored in AWS Secrets Manager as text.
