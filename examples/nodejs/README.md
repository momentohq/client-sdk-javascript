...
After the example completes, the metrics can be viewed in Prometheus by browsing to [localhost:9090](http://localhost:9090)
and querying for 'momento_requests_counter_total':
![Prometheus showing the metrics generated by the example](./resources/prometheus_screenshot.png?raw=true)
