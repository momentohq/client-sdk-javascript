...
export enum LoadGenOperations {
  GET = 'GET',
  PUT = 'PUT',
  GET_AND_PUT = 'GET_AND_PUT',
}
...
export async function executeRequest<T>(
  ...
  try {
    ...
    if (result instanceof StoragePut.Error || result instanceof StorageGet.Error) {
