...
import {Dashboard, GraphWidget, MathExpression, Metric, Stats, Unit} from 'aws-cdk-lib/aws-cloudwatch';
...
export class MomentoMetricsStack extends cdk.Stack {
  ...
  setUpEcsCluster(logGroup: cdk.aws_logs.LogGroup, apiKeySecret: cdk.aws_secretsmanager.Secret) {
    ...
    const policy = new iam.PolicyStatement({
      ...
      actions: ['secretsmanager:GetSecretValue', 'logs:PutLogEvents', 'logs:CreateLogStream', 'ecs:*'],
    });
    policy.addResources(
